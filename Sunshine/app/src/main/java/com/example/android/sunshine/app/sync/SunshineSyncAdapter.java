...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public void sendWeatherInfo(double high, double low, int weatherId) {
        if (mGoogleApiClient == null) {
            Log.d(LOG_TAG, "GoogleApiClient is null");
            return;
        }
        ...
        Log.d(LOG_TAG, "High Temp:" + high + ", Low Temp:" + low + ", WeatherId: " + weatherId);
    }
