...
/*        final Toolbar mToolbar = (Toolbar) mRootView.findViewById(R.id.toolbar);
        AppBarLayout mAppBarLayout = (AppBarLayout) mRootView.findViewById(R.id.appbar);
        ...
        final CoordinatorLayout coordinatorLayout = (CoordinatorLayout) mRootView.findViewById(R.id.coordinatorLayout);
        coordinatorLayout.findViewById(R.id.share_fab).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = Intent.createChooser(ShareCompat.IntentBuilder.from(getActivity())
                        .setType("text/plain").getIntent(), getString(R.string.action_share));
                if (isAvailable(getActivity(), intent)) {
                    Snackbar.make(coordinatorLayout, "No apps can perform this action!",
